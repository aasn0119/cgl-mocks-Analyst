...
const MockForm = () => {
    ...
    switch (name) {
      ...
      case "timeTaken":
        if (value !== "" && (isNaN(num) || num < 0 || num > 120))
          return "Time must be between 0 and 120 minutes";
        break;
      default:
        break;
    }
  ...
  const handleChange = (e) => {
    ...
    const integerFields = ["attemptedQuestions", "correctQuestions", "rank"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        date: "", platform: "", mockId: "",
        totalScore: "", rank: "", percentile: "",
        englishScore: "", reasoningScore: "", quantScore: "", gkScore: "",
        attemptedQuestions: "", correctQuestions: "",
        timeTaken: "", remarks: "",
      });
      setErrors({});
    } catch (error) {
